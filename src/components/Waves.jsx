    ...
    return (
        <div className="header">
            ...
            {/* <div className="inner-header flex"> */}
                ...
                {/* <svg version="1.1" className="logo" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" xmlSpace="preserve">
